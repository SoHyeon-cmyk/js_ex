...
import { ModalWrap, Modal,BgImg, AuthBody, AuthBox, AuthForm, AuthFooter, Button, CancelIcon, ErrMsg, Input, InputBoxWrap, Option, Select, Wrap } from './auth.styles';
import CloseIcon from '@mui/icons-material/Close';
//비동기 통신을 위한 라이브러리
import axios from 'axios';
import {replace, useNaviagte} from 'react-router-dom'
